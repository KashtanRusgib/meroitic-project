...
parallels. The pipeline infrastructure---morphological parsing, NES
comparative analysis, Bayesian scoring, and multi-layer output---is
architecturally sound and ready to process real inscription data when
available. We present this work as a \textit{framework for future
...
\begin{itemize}[nosep]
  ...
  \item v8.0: Honest rebuild with evidence tier classification and synthetic corpus acknowledgment
\end{itemize}
