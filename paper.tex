...
achieves an average confidence of 75.6% across
...
25 reconstructed sections comprising
197 tokens (average confidence: 75.6%).
...
\hfill {\small Lines 1–5 $\cdot$ \textsc{attested/restored} $\cdot$ Confidence: 73%}
...
\hfill {\small Lines 5–10 $\cdot$ \textsc{restored} $\cdot$ Confidence: 76%}
...
\hfill {\small Lines 10–15 $\cdot$ \textsc{attested} $\cdot$ Confidence: 78%}
...
\hfill {\small Lines 15–20 $\cdot$ \textsc{restored} $\cdot$ Confidence: 72%}
...
\hfill {\small Lines 20–25 $\cdot$ \textsc{attested} $\cdot$ Confidence: 53%}
...
\hfill {\small Lines 25–30 $\cdot$ \textsc{attested/restored} $\cdot$ Confidence: 76%}
...
\hfill {\small Lines 41–48 $\cdot$ \textsc{restored} $\cdot$ Confidence: 77%}
...
\hfill {\small Lines 48–55 $\cdot$ \textsc{restored} $\cdot$ Confidence: 81%}
...
\hfill {\small Lines 55–60 $\cdot$ \textsc{restored} $\cdot$ Confidence: 81%}
...
\hfill {\small Lines 60–68 $\cdot$ \textsc{conjectural} $\cdot$ Confidence: 62%}
...
\hfill {\small Lines 81–88 $\cdot$ \textsc{restored} $\cdot$ Confidence: 68%}
...
\hfill {\small Lines 88–95 $\cdot$ \textsc{attested} $\cdot$ Confidence: 73%}
...
\hfill {\small Lines 95–100 $\cdot$ \textsc{attested} $\cdot$ Confidence: 69%}
...
\hfill {\small Lines 115–120 $\cdot$ \textsc{restored} $\cdot$ Confidence: 75%}
...
\hfill {\small Lines 121–130 $\cdot$ \textsc{conjectural} $\cdot$ Confidence: 71%}
...
\hfill {\small Lines 130–138 $\cdot$ \textsc{restored} $\cdot$ Confidence: 76%}
...
\hfill {\small Lines 138–148 $\cdot$ \textsc{restored} $\cdot$ Confidence: 80%}
...
\hfill {\small Lines 148–155 $\cdot$ \textsc{restored} $\cdot$ Confidence: 81%}
...
\hfill {\small Lines 155–161 $\cdot$ \textsc{restored} $\cdot$ Confidence: 80%}
